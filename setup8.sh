...
cat /etc/openvpn/ca.crt >> /home/vps/public_html/7752.ovpn
echo '</ca>' >> /home/vps/public_html/7752.ovpn
cd /home/vps/public_html/
tar -czf /home/vps/public_html/7752.ovpn
tar -czf /home/vps/public_html/7752.ovpn
cd
...
echo -e "\e[38;5;198m   - Download Config OpenVPN : http://$MYIP:85/client.ovpn"  | tee -a log-install.txt
echo -e "\e[38;5;198m   - Mirror (*.tar.gz)       : http://$MYIP:85/openvpn.tar.gz"  | tee -a log-install.txt
echo -e "\e[38;5;198m   - Webmin                  : http://$MYIP:10000/"  | tee -a log-install.txt
echo -e "\e[38;5;198m   - Vnstat                  : http://$MYIP:85/vnstat/"  | tee -a log-install.txt
echo -e "\e[38;5;198m   - MRTG                    : http://$MYIP:85/mrtg/"  | tee -a log-install.txt
...
echo ""  | tee -a log-install.txt
echo "----------- Script Created By AnakSabah------------"
